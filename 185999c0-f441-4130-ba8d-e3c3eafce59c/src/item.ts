...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('185999c0-f441-4130-ba8d-e3c3eafce59c/sounds/Click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('185999c0-f441-4130-ba8d-e3c3eafce59c/models/WallLight_Off.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('185999c0-f441-4130-ba8d-e3c3eafce59c/models/WallLight_On.glb')
